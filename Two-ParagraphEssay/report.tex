\documentclass[10pt,a4paper,twocolumn]{jarticle}  %文字サイズ・用紙サイズ・段組設定
...
\section{はじめに}
論文\cite{guo2022pid}の論文紹介

\bibliography{reference}           %bibtexで参考文献を入れる場合使用
\bibliographystyle{IEEEtran}   %参考文献のスタイル指定

(2頁目のみ)\hspace{1em}\underline{指導教員氏名\hspace{10em}\textcircled{\scriptsize 印}}
